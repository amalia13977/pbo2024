...
import com.amalia.service.NoteService;
...
public class MainController {
    ...
    // Menginisiali data ke dalam firebase
        ...
        result.ifPresent(title -> {
            if (!title.trim().isEmpty()) {
                ...
                if (selectedFolder == null) {
                    // Tidak ada yang dipilih, tambahkan ke root
                    treeView.getRoot().getChildren().add(newNote);
                } else if (selectedFolder.isLeaf() && selectedFolder.getParent() != null && !selectedFolder.getParent().getValue().equals("Root")) {
                    // Sebuah catatan dipilih, tambahkan ke parent dari catatan
                    selectedFolder.getParent().getChildren().add(newNote);
                } else {
                    // Sebuah folder dipilih atau root dipilih
                ...
                // Panggil NoteService untuk menyimpan catatan di luar folder proyek
                noteService.createNoteOutsideProject("");
            }
        });
    }
    ...
    private void handleLogout() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/amalia/view/login.fxml"));
    ...
    private void saveCurrentNote() {
        ...
        noteService.createNoteOutsideProject(noteContent);
    }
}
